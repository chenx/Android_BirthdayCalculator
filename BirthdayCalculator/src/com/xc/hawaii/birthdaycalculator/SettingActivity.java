...
public class SettingActivity extends ActionBarActivity {
	...
	private static double _tax_rate;// = 4.712;
	private static int _tip_rate0;// = 10;
	private static int _tip_rate1;// = 15;
	private static int _tip_rate2;// = 20;
	private static int _tip_rate3;// = 25;
